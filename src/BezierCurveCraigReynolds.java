...
/*Fancier Bezier Curve for craig reynold's path following, probably won't ever use it though*/
public class BezierCurveCraigReynolds {
	 ...
	 * 
	 */
	public BezierCurveCraigReynolds(double x0, double y0, double x1, double y1, double x2, double y2, double x3, double y3, double step ) {
		m_x0 = x0;
		m_y0 = y0;
		m_x1 = x1;
		m_y1 = y1;
